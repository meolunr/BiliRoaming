 ...
 */
object BangumiPlayUrl {

    /**
     * @return new play view response
     */
    fun onLimitedPlayViewResponse(request: PlayViewReq): PlayViewReply? {
        val queryString = constructQueryString(request)
